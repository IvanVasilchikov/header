            ...
            <div class="wrapper">
                <div class="inner">
                    ...
                    <ul class="social-profile">
                        <li>
                            <? $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/mainpage/vklink.php")); ?>
                        </li>
                        <li>
                            <? $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/mainpage/instlink.php")); ?>
                        </li>
                        <li>
                            <? $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/mainpage/youtubelink.php")); ?>
                        </li>
                    </ul>
                    <div class="header-top-callback-button">
                        <a href="" class="btn btn-normal" id="button_header_callback" data-fancybox data-src="#callback-popup" onclick="ym(14537035,'reachGoal','Callback')">Заказать звонок</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="box-header-info">
                        ...
                        <div class="header-number-phone fixationheaderblock">
                            <div class=" header-number">
                                <ul>
                                    <li>
                                        <a href="tel:8 (495) 646-70-45" onclick="ym(14537035,'reachGoal','click-phone')">8 (495) 646-70-45</a><br>
                                        <a href="tel:8 (800) 333-40-55" onclick="ym(14537035,'reachGoal','click-phone')">8 (800) 333-40-55</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
